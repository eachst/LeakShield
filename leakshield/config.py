...
class DetectionConfig:
    ...
    # MDF 引擎参数（第二阶段）
    wasserstein_high: float = 0.15  # Wasserstein 距离高风险阈值
    wasserstein_medium: float = 0.08  # Wasserstein 距离中风险阈值
    ks_high: float = 0.10  # KS 统计量高风险阈值
    ks_medium: float = 0.06  # KS 统计量中风险阈值
    mi_high: float = 0.30  # 互信息高风险阈值
