...
|----------|-----------|---------|---------|---------|------|--------|
| iris_L4_10pct | iris | exact_overlap | high | high | ✅ | 0.780 |
| iris_L4_1pct | iris | exact_overlap | low | low | ✅ | 0.684 |
| cancer_L5 | breast_cancer | label_as_feature | high | high | ✅ | 5.665 |
| diabetes_L1 | diabetes | global_scaling | medium | medium | ✅ | 0.305 |
| timeseries_L6 | synthetic | temporal_overlap | high | high | ✅ | 0.530 |
| wine_clean | wine | None | clean | clean | ✅ | 2.139 |
...
- L5_label_leakage (风险等级: medium, 分数: 0.75)
- L5_label_leakage (风险等级: medium, 分数: 0.75)
